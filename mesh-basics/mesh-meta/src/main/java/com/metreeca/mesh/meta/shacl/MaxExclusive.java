 ...
 *
 * <p>Method-level annotation that specifies an upper bound (exclusive) for property values.
 * Maps to the SHACL {@code sh:maxExclusive} constraint.</p>
 *
 ...
 *
 * <p>This constraint specifies that values must be strictly less than the provided maximum value (it excludes
 * the boundary value itself).</p>
 *
 ...
 * @see <a href="https://www.w3.org/TR/shacl/#MaxExclusiveConstraintComponent">SHACL MaxExclusive Constraint
 *         Component</a>
 */
@Target(METHOD)
@Retention(RUNTIME)
public @interface MaxExclusive {
    ...
    /**
     * Retrieves the exclusive maximum value constraint.
     *
     * @return a string representation of the exclusive upper bound for property values
