 ...
 * @see <a href="https://www.w3.org/TR/shacl/#MinExclusiveConstraintComponent">SHACL MinExclusive Constraint
 *         Component</a>
 */
@Target(METHOD)
@Retention(RUNTIME)
public @interface MinExclusive {
    ...
    /**
     * Retrieves the exclusive minimum value constraint.
     *
     * @return a string representation of the exclusive lower bound for property values
