 ...
 *
 * <p>Method-level annotation that specifies the maximum length allowed for string property values.
 * Maps to the SHACL {@code sh:maxLength} constraint.</p>
 *
 ...
 *
 * @see MinLength Minimum string length constraint
 * @see com.metreeca.mesh.meta.jsonld.Frame Frame annotation for defining JSON-LD frame interfaces
 * @see <a href="https://www.w3.org/TR/shacl/#MaxLengthConstraintComponent">SHACL MaxLength Constraint Component</a>
 */
@Target(METHOD)
@Retention(RUNTIME)
public @interface MaxLength {
     ...
     *
     * @return a positive integer representing the maximum allowed length for string values
     */
    public int value();
