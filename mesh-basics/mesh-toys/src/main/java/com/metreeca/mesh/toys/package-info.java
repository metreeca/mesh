 ...
 * employees, and career events. The model demonstrates comprehensive usage of Metreeca/Mesh frame annotations including
 * relationships, constraints, and data modeling patterns.</p>
 *
 * <h2>Domain Model</h2>
 *
 * <ul>
 ...
 *     <li><strong>{@linkplain com.metreeca.mesh.toys.Event}</strong> - Career milestones and organizational changes
 *         embedded within employee records</li>
 *     <li><strong>{@linkplain com.metreeca.mesh.toys.Catalog}</strong> - Generic collection interface for
 *         organizing domain entities</li>
 * </ul>
 *
 * <h2>Test Data</h2>
 *
 * <p>The {@linkplain com.metreeca.mesh.toys.Resources} interface provides access to realistic test datasets
